...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/sokutore.vue?vue&type=template&id=2a6b6d96&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"columns is-mobile is-centered",staticStyle:{"width":"100%","height":"80%","margin":"0"}},[_vm._ssrNode("<div class=\"column is-4-tablet is-11-mobile\"><div class=\"columns is-mobile is-multiline is-centered is-vcentered\"><div class=\"column is-12 wrapper-content mb-5 tategaki-wrapper\"><div"+(_vm._ssrClass("tategaki pt-3 pb-1",_vm.fontsize))+">"+(_vm._ssrList((3),function(i){return ("<div class=\"trimmed-wrapper\"><span"+(_vm._ssrStyle(null,_vm.highlightStyle[(i - 1) * 2], null))+">"+_vm._ssrEscape(_vm._s(_vm.firstLetter[_vm.page + (i - 1)]))+"</span> <span>"+_vm._ssrEscape(_vm._s(_vm.trimmed[_vm.page + (i - 1)]))+"</span> <span"+(_vm._ssrClass(null,_vm.lastSpace))+(_vm._ssrStyle(null,_vm.highlightStyle[(i - 1) * 2 + 1], null))+">"+_vm._ssrEscape(_vm._s(_vm.lastLetter[_vm.page + (i - 1)]))+"</span></div>")}))+"</div> <div class=\"is-size-7 has-text-centered\">"+_vm._ssrEscape(_vm._s((_vm.page / 3 + 1) +'/'+_vm.length))+"</div></div> <div class=\"column is-12 wrapper-content\"><div class=\"columns is-mobile is-vcentered\"><div class=\"column is-6 has-text-left\"><span id=\"sokutore_button\" class=\"p-2 is-size-7\">&lt; 次へ</span></div> <div class=\"column is-6 has-text-right\"><span id=\"sokutore_button\" class=\"p-2 is-size-7\">最初に戻る &gt;|</span></div></div></div></div></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/sokutore.vue?vue&type=template&id=2a6b6d96&
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".tategaki-wrapper{align-items:center}.tategaki,.tategaki-wrapper{display:flex;flex-flow:column}.tategaki{-ms-writing-mode:tb-rl;-moz-writing-mode:vertical-rl;writing-mode:vertical-rl;height:50vh;letter-spacing:.3em}.trimmed-wrapper span{padding:.3em}.trimmed-wrapper span:first-child{z-index:1;text-align:center;border-radius:50%;letter-spacing:0}.trimmed-wrapper span:nth-child(2){z-index:2;margin-top:-.9em;margin-bottom:-1.2em}.trimmed-wrapper span:nth-child(3){z-index:1;text-align:center;border-radius:50%;letter-spacing:0}.lastSpace{margin-top:.7em}.wrapper-content{border-radius:4px;background:#fff}#sokutore_button{border:.5px solid #3362a8;color:#3362a8;border-radius:8px}.is-size-6-sokutore,.is-size-7-sokutore,.is-size-8-sokutore{font-size:.5em;line-height:6em}", ""]);
// Exports
