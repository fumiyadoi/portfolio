...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/sokutore.vue?vue&type=template&id=79dacca0&
...
// CONCATENATED MODULE: ./pages/sokutore.vue?vue&type=template&id=79dacca0&
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".tategaki-wrapper{align-items:center}.tategaki,.tategaki-wrapper{display:flex;flex-flow:column}.tategaki{-ms-writing-mode:tb-rl;writing-mode:vertical-rl;height:50%;letter-spacing:.3em}.trimmed-wrapper span{padding:.3em}.trimmed-wrapper span:first-child{z-index:1;text-align:center;border-radius:50%;letter-spacing:0}.trimmed-wrapper span:nth-child(2){z-index:2;margin-top:-.9em;margin-bottom:-1.2em}.trimmed-wrapper span:nth-child(3){z-index:1;text-align:center;border-radius:50%;letter-spacing:0}.wrapper-content{border-radius:4px;background:#fff}#sokutore_button{border:.5px solid #3362a8;color:#3362a8;border-radius:8px}.is-size-6-sokutore,.is-size-7-sokutore,.is-size-8-sokutore{font-size:.5em;line-height:6em}", ""]);
// Exports
